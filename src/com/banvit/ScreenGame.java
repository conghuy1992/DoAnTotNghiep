...
public class ScreenGame extends BaseGameActivity implements
	...
	Texture _Texture, _Texture2, _Texture3, _Texture4, _Texture5, _Texture6,
			_Texture10, _Texture9, _Texture7, _Texture8, _Texture11,_texture13,
			_Texture12, bonus, bonus3, target6,_texture14;
	TextureRegion _Region, _Region3, _Region5, _Region7, _Region8, _Region9,
			_Region11, _Region10, _Region12, Rbonus, Rbonus3,_region14,_region13;
	TiledTextureRegion _TiledTextureRegion, _Region6, _Region4;
	...
	LinkedList targetLL6, addTarget6, targetLL, addTarget, dan, addDan, addNo,
			...
			targetll5, addtarget5, addroi, addrunglong,roiLL,runglongLL ;
	AnimatedSprite target, player;

	Sound _shoot, _shoot2, _sound5;
	Texture texturetextchange, texturetextchange2, texturetextchange3,
			besttime;
	Font fonttextchange, fonttextchange2, fonttextchange3, fbesttime;
	long _diem = 0, _loi, deadline = 250;
	ChangeableText _textscore, _textHighScore, _texttime, _textBestTime;
	...
	public void onLoadResources() {
		...
		//
		_Texture5 = new Texture(2048, 256,
				TextureOptions.BILINEAR_PREMULTIPLYALPHA);
		...
		//
		_Texture8 = new Texture(2048, 128,
				TextureOptions.BILINEAR_PREMULTIPLYALPHA);
	...
	public Scene onLoadScene() {
		...
		_winGame = new Sprite(xwin, ywin, _Region11) {
			...
			public boolean onAreaTouched(TouchEvent pSceneTouchEvent,
				...
				if (pSceneTouchEvent.isActionDown()) {
					this.setVisible(false);
					Intent intent = new Intent(ScreenGame.this, maplevel2.class);
	...
	public void restart() {
		...
		runOnUpdateThread(new Runnable() {
			...
			public void run() {
				...
				// _textHighScore.setText("FAIL:" + 0);
				_texttime.setText("TIME:" + 250);
...
//		int rangex = maxx - minx;
	...
	public void restoringPreferences() {
		SharedPreferences pre = getSharedPreferences(prefname, MODE_PRIVATE);
		long best = pre.getLong("highscore", 250);
		long i = 250 - best;
